...
const Pricing = () => {
  ...
  return (
    <div className="bg-gradient-to-t from-gray-300 to-white text-black min-h-screen">
      <nav className="py-5 px-4 sm:py-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-9 py-3 flex items-center justify-between rounded-3xl shadow-md bg-gradient-to-r from-gray-300 to-white">
          <div className="flex items-center">
            <img
              src="/src/Images/pricing/logo1.png"
              alt="Employia Logo"
              className="h-8 sm:h-10"
            />
          </div>
          <div>
            <button className="bg-purple-800 text-white px-4 py-2 sm:px-8 sm:py-3 rounded-full font-bold">
              Log in
            </button>
          </div>
        </div>
